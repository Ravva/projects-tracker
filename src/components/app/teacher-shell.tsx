      ...
      >
        ...
        <SidebarInset className="relative z-10 bg-transparent min-h-screen flex flex-col">
          ...
          >
            ...
            <div className="w-full max-w-[1600px] flex flex-col gap-2 px-4 py-3 sm:px-6 lg:px-8 lg:py-4.5">
          ...
          <main className="px-4 py-6 sm:px-6 lg:px-8 max-w-[1600px] w-full flex-1">
            {children}
          </main>
        </SidebarInset>
      </SidebarProvider>
