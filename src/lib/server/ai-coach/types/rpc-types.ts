...
export interface RpcMethodMap {
  ...
  getHarnessBreakdown: {
    params: DateFilter | undefined;
    result: { labels: string[]; sessions: number[]; requests: number[] };
  };
  getDailyActivity: { params: DateFilter | undefined; result: DailyActivity };
  getWorkspaceBreakdown: {
    params: DateFilter | undefined;
    result: WorkspaceBreakdown;
  };
  ...
  getCodeProduction: {
    params: DateFilter | undefined;
    result: CodeProductionData;
  };
  getConsumption: { params: DateFilter | undefined; result: ConsumptionData };
  getBurndown: {
    params: { config: BurndownConfig; filter?: DateFilter };
    result: BurndownData;
  };
  getAiCredits: { params: DateFilter | undefined; result: AiCreditData };
  getAiCreditBurndown: {
    params: { config: BurndownConfig; filter?: DateFilter };
    result: AiCreditBurndownData;
  };
  getTokenCoverage: {
    params: DateFilter | undefined;
    result: TokenCoverageData;
  };
  getDayTimeline: {
    params: { date?: string; mode?: string; filter?: DateFilter };
    result: DayTimeline;
  };
  getSessions: {
    params: {
  ...
  getContextManagement: {
    params: { filter?: DateFilter } | undefined;
    result: ContextManagementData;
  };
  getWorkspaceContextSessions: {
    params: { workspaceId: string; filter?: DateFilter };
    result: WorkspaceContextSessionsData;
  };
  ...
  getRuleEditor: {
    params: DateFilter | Record<string, unknown>;
    result: unknown;
  };
  getRulePreview: { params: Record<string, unknown>; result: unknown };
  getRuleSource: { params: { ruleId: string }; result: { source: string } };
  saveRule: {
    params: { markdown: string; ruleId?: string };
    result: { ok: boolean; filePath?: string; error?: string };
  };
  updateRuleThreshold: {
    params: { ruleId: string; key: string; value: number };
    result: { ok: boolean };
  };
  reviewLocalRules: {
    params: undefined;
  ...
  testRuleLive: {
    params: { markdown: string; filter?: DateFilter };
    result: {
      ok: boolean;
      triggered: boolean;
      occurrences: number;
  ...
  explainOccurrence: {
    params: { ruleId: string; sessionId: string; filter?: DateFilter };
    result: { ok: boolean; explanation: string; error?: string };
  };
  getRuleCoverage: {
  ...
  evaluateExpression: {
    params: { expr: string; scope: string; filter?: DateFilter };
    result: unknown;
  };
  calibrateRule: {
    params: { ruleId: string; filter?: DateFilter };
    result: unknown;
  };
  ...
  getDataExplorer: {
    params: { field: string; filter?: DateFilter };
    result: unknown;
  };
...
export interface ExtensionMethodMap extends RpcMethodMap {
  ...
  generateLearningResources: {
    params: Record<string, unknown>;
    result: { resources: unknown[]; error?: string };
  };
  ...
  installCatalogItem: {
    ...
    result: { content: string; filename: string; error?: string };
  };
  triageSkills: {
    params: Record<string, unknown>;
    result: { triaged: unknown[] };
  };
  discoverCatalog: {
    params: Record<string, unknown> | undefined;
    result: { items: unknown[]; totalScanned: number };
  };
  triageCatalog: {
    params: Record<string, unknown>;
  ...
  reviewContextFiles: {
    params: { workspaceIds: string[]; count?: number };
    result: { reviews?: unknown[]; error?: string };
  };
  getWorkspaceDeps: {
  ...
  getSdlcToolAnalysis: {
    params: { filter?: DateFilter } | Record<string, unknown>;
    result: { mcpServers: unknown[] };
  };
  getSdlcRepoScan: {
    params: Record<string, unknown> | undefined;
    result: { repos: unknown[] };
  };
  getSdlcGitHubData: { params: Record<string, unknown>; result: unknown };
  saveModelBudgets: {
    params: { budgets: Record<string, number> };
    result: { ok: boolean };
  };
  loadModelBudgets: {
    params: Record<string, unknown> | undefined;
...
export type WebviewRequestMessage<
  M extends ExtensionMethodName = ExtensionMethodName,
> = {
  type: "request";
  id: string;
  method: M;
