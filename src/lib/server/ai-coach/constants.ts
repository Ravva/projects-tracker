...
export const MODEL_TOKEN_RATES: Record<string, TokenRate> = {
  ...
  "gpt-4.1-mini": { input: 0.25, cached: 0.025, output: 2.0 },
  "gpt-4.1-nano": { input: 0.2, cached: 0.02, output: 1.25 },
  "gpt-5-mini": { input: 0.25, cached: 0.025, output: 2.0 },
  "gpt-5.1": { input: 1.75, cached: 0.175, output: 14.0 },
  "gpt-5.1-codex": { input: 1.75, cached: 0.175, output: 14.0 },
  "gpt-5.1-codex-mini": { input: 0.25, cached: 0.025, output: 2.0 },
  "gpt-5.1-codex-max": { input: 1.75, cached: 0.175, output: 14.0 },
