...
export const FIELD_SCHEMA: FieldInfo[] = [
  ...
  },
  {
    name: "timestamp",
    type: "number | null",
    description: "Request timestamp (epoch ms)",
    scope: "request",
    example: "1713216000000",
  },
  {
    name: "messageText",
    type: "string",
  ...
  },
  {
    name: "agentName",
    type: "string",
    description: "Agent name (copilot, custom agent, etc.)",
    scope: "request",
  },
  {
    name: "agentMode",
    type: "string",
    description: "Agent mode: agent, ask, edit, plan, or custom agent name",
    scope: "request",
    example: '"agent"',
  },
  {
    name: "modelId",
    type: "string",
    description: "Model identifier (gpt-4.1, claude-sonnet, etc.)",
    scope: "request",
    example: '"gpt-4.1"',
  },
  {
    name: "toolsUsed",
    type: "string[]",
    description: "List of tools used in this request",
    scope: "request",
  },
  {
    name: "editedFiles",
    type: "string[]",
    description: "Files edited during this request",
    scope: "request",
  },
  {
    name: "referencedFiles",
    type: "string[]",
    description: "Files referenced via #file or @workspace",
    scope: "request",
  },
  {
    name: "slashCommand",
    type: "string",
    description: "Slash command used (empty if none)",
    scope: "request",
  },
  {
    name: "variableKinds",
    type: "object",
    description: "Record<string,number> of variable kinds used",
    scope: "request",
    example: '{ "file": 2 }',
  },
  {
    ...
    type: "string[]",
    description: "Custom instruction files active",
    scope: "request",
  },
  {
    name: "skillsUsed",
    type: "string[]",
    description: "Skills invoked during this request",
    scope: "request",
  },
  {
    name: "firstProgress",
    type: "number | null",
    description: "Time to first progress event (ms)",
    scope: "request",
  },
  {
    name: "totalElapsed",
    type: "number | null",
    description: "Total response time (ms)",
    scope: "request",
  },
  {
    name: "messageLength",
  ...
  },
  {
    name: "userCode",
    type: "object[]",
    description: "Code blocks in user message [{language, loc}]",
    scope: "request",
  },
  {
    name: "aiCode",
    type: "object[]",
    description: "Code blocks in AI response [{language, loc}]",
    scope: "request",
  },
  {
    name: "toolConfirmations",
    type: "object[]",
    description: "Tool confirmation events",
    scope: "request",
  },
  {
    name: "promptTokens",
    type: "number | null",
    description:
      "Prompt token count (total input context size, includes cached portion)",
    scope: "request",
  },
  {
  ...
  },
  {
    ...
    type: "number | null",
    description: "Cached tokens read (subset of promptTokens)",
    scope: "request",
  },
  {
    name: "cacheWriteTokens",
    type: "number | null",
    description: "Cached tokens written / cache creation",
    scope: "request",
  },
  {
    ...
    type: "string",
    description:
      "Reasoning effort level (max | high | medium | low) when known",
    scope: "request",
    example: '"high"',
  },
  {
    name: "workType",
    type: "string",
    description: "Work type classification: feature, bugfix, refactor, etc.",
    scope: "request",
  },
  ...
  },
  {
    name: "harness",
    type: "string",
    description: "IDE harness: VS Code, Local Agent, Xcode, etc.",
    scope: "session",
    example: '"VS Code"',
  },
  {
    name: "creationDate",
    type: "number | null",
    description: "Session creation timestamp (epoch ms)",
    scope: "session",
  },
  {
    name: "lastMessageDate",
    type: "number | null",
    description: "Timestamp of last message (epoch ms)",
    scope: "session",
  },
  {
    name: "requestCount",
  ...
  },
  {
    name: "requests",
    type: "object[]",
    description: "Array of SessionRequest objects",
    scope: "session",
  },
  {
    name: "hasDevcontainer",
    type: "boolean",
    description:
      "Session ran in a devcontainer (detected from runtime /workspaces/ paths)",
    scope: "session",
  },
  {
    name: "customInstructionsBytes",
    type: "number",
    description: "Bytes in .github/copilot-instructions.md (0 if absent)",
    scope: "session",
    example: "4200",
  },
];
...
export const METRIC_PRIMITIVES: MetricPrimitive[] = [
  ...
  },
  {
    ...
    description:
      "Ratio of requests using agentic modes (agent, plan, edit, custom)",
    scope: "requests",
...
export const FUNCTION_CATALOG: FunctionInfo[] = [
  ...
  {
    name: "startsWith",
    signature: "startsWith(s, sub)",
    description: "String starts with prefix",
    category: "string",
  },
  {
    name: "endsWith",
    signature: "endsWith(s, sub)",
    description: "String ends with suffix",
    category: "string",
  },
  {
    name: "matches",
    signature: "matches(s, /re/)",
  ...
  },
  {
    name: "hour",
    signature: "hour(ts)",
    description: "Extract hour (0-23) from ms",
    category: "date",
  },
  {
    name: "dayOfWeek",
  ...
  {
    name: "includes",
    signature: "includes(arr, val)",
    description: "Array includes value",
    category: "array",
  },
  {
    name: "some",
    signature: "some(arr, field)",
    description: "Any element has truthy field",
    category: "array",
  },
  {
    name: "count",
  ...
  {
    name: "sum",
    signature: "sum(arr, field)",
    description: "Sum numeric field across array",
    category: "array",
  },
  {
    name: "avg",
    signature: "avg(arr, field)",
    description: "Average numeric field",
    category: "array",
  },
  {
    name: "unique",
    signature: "unique(arr, field)",
    description: "Count distinct values",
    category: "array",
  },
  {
    name: "flatUnique",
    signature: "flatUnique(arr, field)",
    description: "Count distinct values across sub-arrays",
    category: "array",
  },
  {
    name: "reasoningEffortStats",
    signature: "reasoningEffortStats(reqs[, level])",
    description: 'Premium reasoning-effort usage ratio (level: "high"|"max")',
    category: "array",
  },
  {
    name: "instructionBloatStats",
    signature: "instructionBloatStats(sessions[, maxBytes])",
    description: "Custom-instructions size analysis per workspace",
    category: "array",
  },

  {
    name: "excessFileContextStats",
    signature: "excessFileContextStats(reqs[, minFiles])",
    description: "Outlier requests with huge referencedFiles arrays",
    category: "array",
  },
  {
    name: "hasSkillByPattern",
    signature: "hasSkillByPattern(reqs, /pat/)",
    description: "1 if any skillsUsed entry matches the regex",
    category: "array",
  },
  {
    name: "keys",
  ...
  {
    name: "has",
    signature: "has(obj, key)",
    description: "Object has key",
    category: "object",
  },
  {
    name: "coalesce",
