...
- следующим этапом после текущей правки остается подключить боевой Telegram webhook на публичный URL и провести первую живую привязку ученика через персональную invite-ссылку.
