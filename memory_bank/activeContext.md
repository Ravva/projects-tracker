...
- закрыто в текущей сессии: пакетный `GitHub sync + AI` автоматизирован через GitHub Actions каждые 4 часа, используя защищенный server route вместо ручного запуска из teacher UI;
