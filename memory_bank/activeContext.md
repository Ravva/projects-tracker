...
- следующим этапом после текущей правки остается провести end-to-end проверку Telegram-отправки на живом `chat_id` и при необходимости отдельно добавить UI для массовых уведомлений.
