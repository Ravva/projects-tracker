...
Модуль читает данные через server-side repository `students`. При отсутствии Appwrite-конфигурации или записей показывает empty states; следующий этап - добавить реальный CRUD.
