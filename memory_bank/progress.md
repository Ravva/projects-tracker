...
- 2026-06-03: Выполнен рефакторинг страницы посещаемости (/attendance) и отчетов по посещаемости (/attendance/report) в стиле Untitled UI Slate.
- 2026-06-02: Полный визуальный редизайн разделов учеников (/students), личного кабинета (/my-project) и экрана Login.
- 2026-06-02: Создана спецификация дизайн-токенов DESIGN.md.
